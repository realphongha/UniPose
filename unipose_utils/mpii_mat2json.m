...
data = load('/content/data/MPII/mpii_human_pose_v1_u12_2/mpii_human_pose_v1_u12_1.mat');
fprintf('Done.\n')
%% open file
fprintf('Open file mpii_human_pose_annotations.json\n')
path = '/content/data/MPII/mpii_human_pose_v1_u12_2/';
fileID = fopen(strcat(path, 'mpii_annotations.json'),'w');
