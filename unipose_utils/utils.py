...
from unipose_utils import lsp_lspet_data       as lsp_lspet_data
from unipose_utils import mpii_data            as mpii_data
from unipose_utils import mpii_data            as Mpii
# from unipose_utils       import coco_data            as coco_data
from unipose_utils import penn_action_data     as penn_action
# from unipose_utils       import ntid_data            as ntid_data
# from unipose_utils       import posetrack_data       as posetrack_data
from unipose_utils import bbc_data             as bbc_data
...
def printAccuracies(mAP, AP, mPCKh, PCKh, mPCK, PCK, dataset):
    if dataset == "LSP":
        print("\nmAP:   %.2f%%" % (mAP * 100))
        print(
            "APs:     Void = %2.2f%%, Right Ankle = %2.2f%%,  Right Knee = %2.2f%%,   Right Hip = %2.2f%%,       Left Hip = %2.2f%%," \
        ...
        print(
            "PCKs:    Void = %2.2f%%, Right Ankle = %2.2f%%,  Right Knee = %2.2f%%,   Right Hip = %2.2f%%,       Left Hip = %2.2f%%," \
        ...
        print(
            "PCKhs:   Void = %2.2f%%, Right Ankle = %2.2f%%,  Right Knee = %2.2f%%,   Right Hip = %2.2f%%,       Left Hip = %2.2f%%," \
        ...
        print(
            ...
            % (PCK[0] * 100, PCK[1] * 100, PCK[2] * 100, PCK[3] * 100, PCK[4] * 100, PCK[5] * 100, PCK[6] * 100,
               PCK[7] * 100, PCK[8] * 100, PCK[9] * 100, PCK[10] * 100, \
        ...
        print(
            ...
            % (PCKh[0] * 100, PCKh[1] * 100, PCKh[2] * 100, PCKh[3] * 100, PCKh[4] * 100, PCKh[5] * 100, PCKh[6] * 100,
               PCKh[7] * 100, PCKh[8] * 100, PCKh[9] * 100, \
               PCKh[10] * 100, PCKh[11] * 100, PCKh[12] * 100, PCKh[13] * 100, PCKh[14] * 100, PCKh[15] * 100,
               PCKh[16] * 100))

    elif dataset == "COCO":
        print("\nmAP:   %.2f%%" % (mAP * 100))
        print(
            "APs:   %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%" \
            % (AP[0] * 100, AP[1] * 100, AP[2] * 100, AP[3] * 100, AP[4] * 100, AP[5] * 100, AP[6] * 100, AP[7] * 100,
               AP[8] * 100, AP[9] * 100, PCKh[10] * 100, \
        ...
        print("mPCK:  %.2f%%" % (mPCK * 100))
        print(
            "PCKs:  %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%" \
            % (PCK[0] * 100, PCK[1] * 100, PCK[2] * 100, PCK[3] * 100, PCK[4] * 100, PCK[5] * 100, PCK[6] * 100,
               PCK[7] * 100, PCK[8] * 100, PCK[9] * 100, PCK[10] * 100, \
               PCK[11] * 100, PCK[12] * 100, PCK[13] * 100, PCK[14] * 100, PCK[15] * 100, PCK[16] * 100,
               PCKh[17] * 100))
        ...
        print("mPCKh: %.2f%%" % (mPCKh * 100))
        print(
            "PCKhs: %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%" \
            % (PCKh[0] * 100, PCKh[1] * 100, PCKh[2] * 100, PCKh[3] * 100, PCKh[4] * 100, PCKh[5] * 100, PCKh[6] * 100,
               PCKh[7] * 100, PCKh[8] * 100, PCKh[9] * 100, \
               PCKh[10] * 100, PCKh[11] * 100, PCKh[12] * 100, PCKh[13] * 100, PCKh[14] * 100, PCKh[15] * 100,
               PCKh[16] * 100, PCKh[17] * 100))

    elif dataset == "Penn_Action":
        print("\nmAP:   %.2f%%" % (mAP * 100))
        print(
            "APs:   %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%" \
            % (AP[0] * 100, AP[1] * 100, AP[2] * 100, AP[3] * 100, AP[4] * 100, AP[5] * 100, AP[6] * 100, AP[7] * 100,
               AP[8] * 100, AP[9] * 100, PCKh[10] * 100, \
        ...
        print("mPCK:  %.2f%%" % (mPCK * 100))
        print(
            "PCKs:  %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%" \
            % (PCK[0] * 100, PCK[1] * 100, PCK[2] * 100, PCK[3] * 100, PCK[4] * 100, PCK[5] * 100, PCK[6] * 100,
               PCK[7] * 100, PCK[8] * 100, PCK[9] * 100, PCK[10] * 100, \
        ...
        print("mPCKh: %.2f%%" % (mPCKh * 100))
        print(
            "PCKhs: %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%" \
            % (PCKh[0] * 100, PCKh[1] * 100, PCKh[2] * 100, PCKh[3] * 100, PCKh[4] * 100, PCKh[5] * 100, PCKh[6] * 100,
               PCKh[7] * 100, PCKh[8] * 100, PCKh[9] * 100, \
        ...
        print("\nmAP:   %.2f%%" % (mAP * 100))
        print(
            "APs:     Void = %2.2f%%,     Spine Base = %2.2f%%,   Spine Mid = %2.2f%%,           Neck = %2.2f%%,        Head = %2.2f%%," \
            % (AP[0] * 100, AP[1] * 100, AP[2] * 100, AP[3] * 100, AP[4] * 100))
        print(
            "Shoulder Left = %2.2f%%,     Elbow Left = %2.2f%%,  Wrist Left = %2.2f%%,  Hand Tip Left = %2.2f%%,    Hip Left = %2.2f%%," \
            % (AP[5] * 100, AP[6] * 100, AP[7] * 100, AP[8] * 100, AP[13] * 100))
        print(
            "Shoulder Right = %2.2f%%,   Elbow Right = %2.2f%%, Wrist Right = %2.2f%%, Hand Tip Right = %2.2f%%,   Hip Right = %2.2f%%" \
            % (AP[9] * 100, AP[10] * 100, AP[11] * 100, AP[12] * 100, AP[14] * 100))
        print(
            "Spine Shoulder = %2.2f%%, Hand Tip Left = %2.2f%%,  Thumb Left = %2.2f%%, Hand Tip Right = %2.2f%%, Thumb Right = %2.2f%%" \
        ...
        print("\nmAP:   %.2f%%" % (mAP * 100))
        print(
            "APs: BG = %2.2f%%, HD = %2.2f%%, LH = %2.2f%%, RH = %2.2f%%, LE = %2.2f%% RE = %2.2f%%, LS = %2.2f%%, RS = %2.2f%%," \
            % (AP[0] * 100, AP[1] * 100, AP[2] * 100, AP[3] * 100, AP[4] * 100, AP[5] * 100, AP[6] * 100, AP[7] * 100))
